<div>
<!-- component -->
<section class="bg-white dark:bg-emerald-800">
      ...
      <div class="flex items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5">
          <div class="w-full">
              ...
              <p class="mt-4 text-gray-500 dark:text-gray-400">
                  Si tienes alguna duda o aclaracion, ponte en contacto con nosotros
              </p>

              <div class="mt-6">
                  <h1 class="text-gray-500 dark:text-gray-300">Escribe tu duda o aclaración</h1>
                  <br>
